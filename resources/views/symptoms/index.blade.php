        ...
        <div class="card">
            <div class="card-body">
                <form id="symptom-form" action="{{ route('symptoms.recommend') }}" method="POST">
                        ...
                        @foreach($symptoms as $symptom)
                            <div class="col-md-3 mb-3">
                                <div class="form-check">
                                    <input type="checkbox" 
                                           class="form-check-input @error('symptoms') is-invalid @enderror" 
                                           name="symptoms[]" 
                                           value="{{ $symptom->id }}" 
                    ...
                    {{-- Inline validation error message for symptoms --}}
                    @error('symptoms')
                        <div class="invalid-feedback d-block" style="margin-top: -10px; margin-bottom: 15px;">
                            {{ $message }}
                        </div>
                    @enderror
