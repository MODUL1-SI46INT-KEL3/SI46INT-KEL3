            ...
            <form action="<?php echo e(route('admins.login')); ?>" method="POST">
                ...
                <div class="form_box">
                    <div class="form_input">
                        ...
                        <input type="text" id="username" name="username" placeholder="Username" value="<?php echo e(old('username')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="login_admin">
                    <a href="<?php echo e(url('patients/login')); ?>">Or Log In as Patient</a>
                </div> 
...
</html><?php /**PATH D:\Codingan\SI46INT-KEL3-main\resources\views/admins/login.blade.php ENDPATH**/ ?>