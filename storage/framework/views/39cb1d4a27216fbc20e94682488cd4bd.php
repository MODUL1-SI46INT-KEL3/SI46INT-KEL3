...
<section class="articles-section">
    <div class="container">
        ...
        <form action="<?php echo e(route('articles.search')); ?>" method="GET" class="mb-4" style="style="margin-top:5px;"">
        <input 
            type="text" 
            name="query" 
...
</section><?php /**PATH D:\Codingan\SI46INT-KEL3-main\resources\views/articles/search.blade.php ENDPATH**/ ?>