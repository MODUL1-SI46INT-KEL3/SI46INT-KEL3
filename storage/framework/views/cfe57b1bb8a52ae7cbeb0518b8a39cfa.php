...
<body>
    <aside class="sidebar">
        <ul class="list-unstyled">
            <li>
                <a class="active" href="<?php echo e(route('admins.home')); ?>">
                    TELKOMEDIKA ADMIN
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('adminPatient.index')); ?>" class="sidebar-link">Patient</a>
            </li>
            <li>
                <a href="<?php echo e(route('adminmedicine.index')); ?>" class="sidebar-link">Medicine</a>
            </li>
            <li>
            ...
            <li>
                <a href="<?php echo e(route('adminMedicalRecord.index')); ?>" class="sidebar-link">Medical Record</a>
            </li>
            <li>
        ...
        <a href="<?php echo e(route('views.landing')); ?>" class="logout">
            <button>Logout</button>
        </a>
    </aside>

</body>
</html><?php /**PATH D:\Codingan\SI46INT-KEL3-main\resources\views/navigation/sidebar.blade.php ENDPATH**/ ?>